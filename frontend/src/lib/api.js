/**
 * Client de l'API de la Fondation (dossier backend). Module serveur uniquement.
 *
 ...
 *
 * L'URL de base vient de FCM_API_URL (déploiement Vercel de l'API) ;
 * en local, l'API tourne sur http://localhost:4000 (npm run dev dans backend).
 */
import "server-only";
